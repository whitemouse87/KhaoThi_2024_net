...
{
    public interface IBCThongTinConThiRepository
    {
        /// <summary>
        ...
        Task<KhaoThi_5_THPT_ThongTin_ConThi?> GetByKeysAsync(string MaTruong, string CCCD, string MaDinhDanhCuaCon); // Use nullable return type
