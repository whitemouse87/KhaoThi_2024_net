...
//    {
//        //Active phân trang
//        public record LoadPaginatedDonVisAction(int Page, int PageSize, string? SearchTerm);
//        public record LoadPaginatedDonVisSuccessAction(PaginatedResult<KhaoThi_1_THPT_ThongTin_DonViModel> PaginatedDonVis);
//        public record LoadPaginatedDonVisFailureAction(string ErrorMessage);

//        //Actions lựa chọn đơn vị
//        public record SelectDonViAction(KhaoThi_1_THPT_ThongTin_DonViModel DonVi);

//        //Actions cập nhật thông tin
//        public record UpdateDonViAction(KhaoThi_1_THPT_ThongTin_DonViModel DonVi);
//        public record UpdateDonViSuccessAction(KhaoThi_1_THPT_ThongTin_DonViModel DonVi);
//        public record UpdateDonViFailureAction(string ErrorMessage);


//        //Actions cập nhật Active
//        public record ChangeActiveAction(string Matruong, bool Active);
//        public record ChangeActiveSuccessAction(string MaTruong);
//        public record ChangeActiveFailureAction(string ErrorMessage);

//        //Actions cập nhật Lock
//        public record ChangeLockAction(string Matruong, bool Lock);
//        public record ChangeLockSuccessAction(string MaTruong);
//        public record ChangeLockFailureAction(string ErrorMessage);

//        //Actions tìm trường qua mã trường
//        public record GetDonViByMaTruongAction(string MaTruong);
//        public record GetDonViByMaTruongSuccessAction(KhaoThi_1_THPT_ThongTin_DonViModel DonVi);
//        public record GetDonViByMaTruongFailureAction(string ErrorMessage);
